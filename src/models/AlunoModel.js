...
Aluno.prototype.valida = function() {
  ...
  const temCurso = this.body.curso_id !== null && this.body.curso_id !== undefined && this.body.curso_id !== '';
...
Aluno.prototype.cleanUp = function() {
  ...
  this.body = {
    ...
    curso_id: this.body.curso_id && this.body.curso_id !== '' ? 
      (typeof this.body.curso_id === 'number' ? this.body.curso_id : parseInt(this.body.curso_id)) : null,
  };
...
Aluno.prototype.edit = async function(id) {
  try {
    ...
    if (numAffectedRows === 0) {
      this.errors.push('Nenhuma alteração foi realizada');
      return;
    }
...
Aluno.buscaAlunos = async function() {
  try {
    ...
    // Buscar informações dos cursos se houver alunos
